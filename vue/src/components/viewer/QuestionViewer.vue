    ...
    <div class="mt=3">
      ...
      <div v-else-if="question.type === 'checkbox'">
        ...
        >
          <input
            ...
            type="checkbox"
            class="focus:ring-indig-500 h-4 w-4 text-indigo-600 border-gray-300 rounded"
          />
          <label
            for="option.uuid"
            class="ml-3 block text-sm font-medium text-gray-700"
      ...
      <div v-else-if="question.type === 'text'">
        <input
          ...
          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shados-sm sm:text-sm border-gray-300 rounded-md"
        />
      </div>
