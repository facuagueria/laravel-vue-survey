      ...
      >
        ...
        <div class="flex justify-between items-center mt-3">
          ...
          <button
            ...
            class="h8 w-8 flex items-center justify-center rounded-full border border-transparent text-sm text-red-500 focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
...
function deleteSurvey(survey) {
  if (
    confirm(
      `Are you sure you want to delete this survey? Operation cant't be undone!!`
    )
  ) {
    //delete survey
  }
